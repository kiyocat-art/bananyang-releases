        ...
        <div className="flex flex-col h-full break-keep">
            <div className="flex-shrink-0 p-1 bg-black/20 border-b border-white/10">
                <div className="flex items-center bg-black/20 rounded-lg p-0.5 gap-0.5">
                    <Tooltip tip={t('tooltip.section.conceptDesign', language)} position="top" className="flex-1">
                    ...
                    <Tooltip tip={t('aiEdit.title', language)} position="top" className="flex-1">
                    ...
                    <Tooltip tip={getCameraTabTooltip()} position="top" className="flex-1">
                        <button
                    ...
                    <Tooltip tip={getPoseTabTooltip()} position="top" className="flex-1">
                        <button
                    ...
                    <Tooltip tip={t('tooltip.painting', language)} position="top" className="flex-1">
            ...
            <div ref={rightPanelScrollRef} className="h-full p-2 space-y-2 overflow-y-auto custom-scrollbar">
            ...
            <HoverEdgeAutoScroll targetRef={rightPanelScrollRef} />
            </div>
        </div>
    )
});
